...
% neighbouring subplots. Unfortunately Matlab subplot function lacks this functionality, and the margins between
...
% Last update:      Nikolay S. 21/04/2011 (according to Alan B's comment).
%
