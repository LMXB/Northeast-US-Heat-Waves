...
%Verify NARR specific humidity by comparing with MesoWest over 2002-14
...
%This all uses CLIMOD station data, rather than the inferior NCDC version
        ...
        for variab=1:size(varsdes,1)
            ...
            for year=yeariwf:yeariwl
                ...
                for mon=moniwf:moniwl
                    ...
                    %If doing, prepare to make line graphs of variation
